...
document.getElementById("rzp-button1").onclick = function (e) {
  ...
  console.log(currentlogedin.bill)
  var options = {
    key: "rzp_test_PV1oQ0oMtgXOsq", // Enter the Key ID generated from the Dashboard
    amount: currentlogedin.bill*100, // Amount is in currency subunits. Default currency is INR. Hence, 50000 refers to 50000 paise
    currency: "INR",
